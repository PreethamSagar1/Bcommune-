...
urlpatterns = [
    ...
    path('freelance-project/<int:project_id>/my-bid/', 
     ...
     path('company/dashboard/assessmentc',views.assessmentc,name='assessmentc'),
     path('create_own/', views.create_own_assessment, name='create_own_assessment'),
     path('prefer_bcommune/', views.prefer_bcommune_assessment, name='prefer_bcommune_assessment'),
